...
# 12-gene expression & survival analysis for Şekil 4.13–4.15
# (canonical numbering: docs/figure_table_mapping.md)
#
...
# ============================================================================
# 1. COX FOREST PLOT — Median-split Cox PH (Şekil 4.13–4.14)
# ============================================================================
cat("\n--- 1. Cox forest plot ---\n")
...
# ============================================================================
# 2. CONTINUOUS COX FOREST PLOT — Robustness analysis (Şekil 4.15)
# ============================================================================
...
# ============================================================================
# 3. EXPRESSION SUMMARY — From GDCdata cache or Table01 fallback
# Generated by Phase 2; not assigned a Şekil number in the canonical thesis map
# (docs/figure_table_mapping.md). Historical comments that numbered this as
# Şekil 4.15 were stale relative to the final 4.13–4.15 Cox mapping.
# ============================================================================
...
cat("Files created:\n")
cat("  tcga_cox_orman.{pdf,png,tiff}         — Cox forest plot (Şekil 4.13–4.14)\n")
cat("  tcga_surekli_cox_orman.{pdf,png,tiff} — Continuous Cox robustness (Şekil 4.15)\n")
if (!is.null(expr_try) && nrow(expr_try) >= 8) {
  cat("  tcga_ifade_kutu.{pdf,png,tiff}       — Expression boxplot (generated; no Şekil in canonical map)\n")
} else {
  cat("  tcga_ifade_cubuk.{pdf,png,tiff}      — Expression bar plot (generated; no Şekil in canonical map)\n")
}
